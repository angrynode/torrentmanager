...
impl PathBreadcrumb {
    /// Produce a list of path ancestors from the bottom up.
    ///
    /// The current path is disregarded, we only consider ancestors.
    pub fn for_filesystem_path(path: &Utf8PathBuf) -> Vec<PathBreadcrumb> {
